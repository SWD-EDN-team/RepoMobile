...
const ProductCard: React.FC<ProductCardProps> = ({ item, updateQuantity, removeItem }) => {
  return (
...
const styles = StyleSheet.create({
  ...
  image: { width: width * 0.3, height: height * 0.19, borderRadius: 10, marginRight: 10, marginBottom: 10 },
  info: { flex: 1 },

  title: { fontSize: 20, fontWeight: "bold" },
  reviews: { fontSize: 12, color: "gray" },
  price: { fontSize: 25, fontWeight: "bold", marginTop: "15%", marginBottom: 5 },
  ...
  saveButton: { backgroundColor: "#f0f0f0", padding: 15, borderRadius: 5, marginEnd: "10%" },
